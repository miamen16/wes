...
add_action( 'acf/init', function () {
	...
	acf_add_local_field_group( array(
    	...
    	'fields'   => array(
    		array( 
    			...
    			'name' => 'layout', 
    			'type' => 'button_group', 
    			'choices' => array( 'carousel' => 'Carousel', 'grid' => 'Grid' ), 
    			'default_value' => 'grid' 
    		),
    		array(
    				...
    				array(
    					...
    					'sub_fields' => array(
    						array(
    							...
    							'type' => 'text',
    							'default_value' => '',
    							'placeholder' => 'e.g., 1, 2, 3, or I, II, III',
    							'instructions' => 'Optional: Display a number or icon before the text',
    						),
    						array(
    							'key' => 'field_related_text',
    							'label' => 'Text',
    							'name' => 'text',
    							'type' => 'text',
    							'required' => 1,
    							'placeholder' => 'Principle name',
    							'instructions' => 'This will be used as the collapsible title',
    						),
    						array(
    							'key' => 'field_related_link',
    							'label' => 'Link (optional)',
    							'name' => 'link',
    							'type' => 'url',
    							'placeholder' => 'https://example.com/principle',
    							'instructions' => 'Optional: Add a URL to make this principle clickable',
    						),
    					),
    				),
    				array(
		...
		'fields'   => array(
			array(
				...
				'sub_fields' => array(
					...
					wes_acf_text( 'field_tc_link', 'Link', 'link' ),
				),
			),
		),
	...
	acf_add_local_field_group( array(
		...
		'title'    => 'CTA Banner',
		'fields'   => array(
			wes_acf_text( 'field_cta_title', 'Title', 'title' ),
			wes_acf_textarea( 'field_cta_text', 'Text', 'text' ),
			wes_acf_text( 'field_cta_btn', 'Button label', 'btn' ),
			wes_acf_text( 'field_cta_link', 'Button link', 'link' ),
			wes_acf_image( 'field_cta_img', 'Image', 'image' ),
			array( 'key' => 'field_cta_color', 'label' => 'Colour', 'name' => 'color', 'type' => 'select', 'choices' => array( 'teal' => 'Light teal', 'cream' => 'Cream', 'green' => 'Light green', 'orange' => 'Light orange' ), 'default_value' => 'teal' ),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-cta-banner' ) ) ),
	) );

	acf_add_local_field_group( array(
		'key'      => 'group_block_steps',
		'title'    => 'How-to Steps',
		'fields'   => array(
			wes_acf_text( 'field_steps_heading', 'Heading', 'heading' ),
			array(
				'key' => 'field_steps_items', 'label' => 'Steps', 'name' => 'items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add step',
				'sub_fields' => array(
					wes_acf_text( 'field_step_title', 'Step title', 'title' ),
					wes_acf_textarea( 'field_step_text', 'Step description', 'text' ),
				),
			),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-steps' ) ) ),
	) );

	acf_add_local_field_group( array(
		'key'      => 'group_block_checklist',
		'title'    => 'Checklist',
		'fields'   => array(
			wes_acf_text( 'field_cl_heading', 'Heading', 'heading' ),
			array(
				'key' => 'field_cl_items', 'label' => 'Items', 'name' => 'items', 'type' => 'repeater', 'layout' => 'table', 'button_label' => 'Add item',
				'sub_fields' => array(
					wes_acf_text( 'field_cl_item', 'Item', 'item' ),
				),
			),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-checklist' ) ) ),
	) );

	acf_add_local_field_group( array(
		'key'      => 'group_block_download',
		'title'    => 'Download Button',
		'fields'   => array(
			wes_acf_text( 'field_dl_label', 'Label', 'label' ),
			array( 'key' => 'field_dl_file', 'label' => 'File', 'name' => 'file', 'type' => 'file', 'return_format' => 'url' ),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-download' ) ) ),
	) );

	acf_add_local_field_group( array(
		'key'      => 'group_block_action_cards',
		'title'    => 'Action Cards',
		'fields'   => array(
			array(
				'key' => 'field_ac_items', 'label' => 'Cards', 'name' => 'items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add card',
				'sub_fields' => array(
					wes_acf_image( 'field_ac_img', 'Image', 'image' ),
					array( 'key' => 'field_ac_cat', 'label' => 'Category', 'name' => 'category', 'type' => 'select', 'choices' => array( 'howto' => 'How-to guide', 'checklist' => '5-step checklist' ) ),
					wes_acf_text( 'field_ac_label', 'Badge label', 'label' ),
					wes_acf_text( 'field_ac_title', 'Title', 'title' ),
					wes_acf_text( 'field_ac_link', 'Link', 'link' ),
					array( 'key' => 'field_ac_med', 'label' => 'Show "5" medallion', 'name' => 'medallion', 'type' => 'true_false', 'ui' => 1 ),
					array( 'key' => 'field_ac_is_new', 'label' => 'Mark as NEW', 'name' => 'is_new', 'type' => 'true_false', 'ui' => 1, 'instructions' => 'Show a "NEW" badge on this card.' ),
				),
			),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-action-cards' ) ) ),
	) );

	acf_add_local_field_group( array(
		'key'      => 'group_block_quiz',
		'title'    => 'Quiz CTA',
		'fields'   => array(
			wes_acf_text( 'field_qz_heading', 'Heading', 'heading' ),
			wes_acf_textarea( 'field_qz_lead', 'Lead', 'lead' ),
			wes_acf_text( 'field_qz_note', 'Note', 'note' ),
			wes_acf_image( 'field_qz_img', 'Illustration', 'image' ),
			wes_acf_text( 'field_qz_link', 'Link', 'link' ),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-quiz-cta' ) ) ),
	) );

	acf_add_local_field_group( array(
		'key'      => 'group_block_blobs',
		'title'    => 'Audience Blobs',
		'fields'   => array(
			array(
				'key' => 'field_blob_items', 'label' => 'Blobs', 'name' => 'items', 'type' => 'repeater', 'layout' => 'block', 'max' => 3, 'button_label' => 'Add blob',
				'sub_fields' => array(
					array( 'key' => 'field_blob_color', 'label' => 'Colour', 'name' => 'blob', 'type' => 'select', 'choices' => array( 'teal' => 'Teal', 'green' => 'Green', 'gold' => 'Gold' ) ),
					wes_acf_image( 'field_blob_icon', 'Icon', 'icon' ),
					wes_acf_textarea( 'field_blob_label', 'Label', 'label', 2 ),
					wes_acf_text( 'field_blob_link', 'Link', 'link' ),
				),
			),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-audience-blobs' ) ) ),
	) );
	...
	acf_add_local_field_group( array(
		...
		'fields'   => array(
			wes_acf_text( 'field_od_heading', 'Heading', 'heading' ),
			wes_acf_textarea( 'field_od_subtitle', 'Subtitle', 'subtitle' ),
			wes_acf_textarea( 'field_od_body', 'Body', 'body', 4 ),
			array(
				'key' => 'field_od_filters', 'label' => 'Filters', 'name' => 'filters', 'type' => 'repeater', 'layout' => 'table', 'button_label' => 'Add filter',
				'sub_fields' => array(
					wes_acf_text( 'field_od_flabel', 'Label', 'label' ),
					array( 'key' => 'field_od_ficon', 'label' => 'Icon', 'name' => 'icon', 'type' => 'select', 'choices' => array( 'map' => 'Map', 'folder' => 'Folder', 'people' => 'People' ) ),
				),
			),
			array(
				'key' => 'field_od_orgs', 'label' => 'Organisations', 'name' => 'orgs', 'type' => 'repeater', 'layout' => 'table', 'button_label' => 'Add organisation',
				'sub_fields' => array(
					wes_acf_text( 'field_od_oname', 'Name', 'name' ),
					wes_acf_text( 'field_od_olink', 'Link', 'link' ),
				),
			),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-org-directory' ) ) ),
	) );
	...
	acf_add_local_field_group( array(
		...
		'title'    => 'Map Banner',
		'fields'   => array(
			wes_acf_textarea( 'field_mb_banner', 'Banner text', 'banner', 2 ),
			wes_acf_image( 'field_mb_map', 'Map image', 'map' ),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-map-banner' ) ) ),
	) );

	acf_add_local_field_group( array(
		'key'      => 'group_block_lesson_hero',
		'title'    => 'Lesson Hero',
		'fields'   => array(
			wes_acf_text( 'field_lh_eyebrow', 'Eyebrow', 'eyebrow' ),
			wes_acf_text( 'field_lh_sub_eyebrow', 'Sub Eyebrow Description', 'sub_eyebrow' ),
			wes_acf_text( 'field_lh_title', 'Title', 'title' ),
			wes_acf_textarea( 'field_lh_intro', 'Intro', 'intro' ),
			wes_acf_image( 'field_lh_image', 'Illustration', 'image' ),
			wes_acf_text( 'field_lh_alt', 'Illustration alt text (SEO)', 'alt' ),
			wes_acf_text( 'field_lh_cta1', 'Button 1 label', 'cta1_label' ),
			wes_acf_text( 'field_lh_cta1l', 'Button 1 link', 'cta1_link' ),
			wes_acf_text( 'field_lh_cta2', 'Button 2 label', 'cta2_label' ),
			wes_acf_text( 'field_lh_cta2l', 'Button 2 link', 'cta2_link' ),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-lesson-hero' ) ) ),
	) );

    acf_add_local_field_group( array(
    	'key'      => 'group_block_custom_hero', // تم التغيير لـ custom_hero
    	'title'    => 'Custom Hero',
    	'fields'   => array(
    		wes_acf_text( 'field_ch_eyebrow', 'Eyebrow', 'eyebrow' ), // تم تغيير البادئة لـ ch_
    		wes_acf_text( 'field_ch_sub_eyebrow', 'Sub Eyebrow Description', 'sub_eyebrow' ),
    		wes_acf_text( 'field_ch_title', 'Title', 'title' ),
    		wes_acf_textarea( 'field_ch_intro', 'Intro', 'intro' ),
    		wes_acf_image( 'field_ch_image', 'Illustration', 'image' ),
    		wes_acf_image( 'field_ch_emblem_image', 'Custom Emblem Image', 'emblem_image' ),
    		wes_acf_text( 'field_ch_alt', 'Illustration alt text (SEO)', 'alt' ),
    		wes_acf_text( 'field_ch_cta1', 'Button 1 label', 'cta1_label' ),
    		wes_acf_text( 'field_ch_cta1l', 'Button 1 link', 'cta1_link' ),
	...
	acf_add_local_field_group( array(
		'key'      => 'group_block_step_cards',
		'title'    => 'Step Cards',
		'fields'   => array(
			array(
				'key' => 'field_sc_items', 'label' => 'Steps', 'name' => 'items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add step',
				'sub_fields' => array(
					wes_acf_text( 'field_sc_label', 'Step label', 'label' ),
					wes_acf_text( 'field_sc_title', 'Title', 'title' ),
					wes_acf_textarea( 'field_sc_text', 'Description', 'text', 4 ),
					array( 'key' => 'field_sc_color', 'label' => 'Colour', 'name' => 'color', 'type' => 'select', 'choices' => array( 'orange' => 'Orange', 'teal' => 'Teal', 'gold' => 'Gold', 'green' => 'Green', 'blue' => 'Blue' ) ),
				),
			),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-step-cards' ) ) ),
	) );
    ...
    acf_add_local_field_group( array(
            ...
            'title'    => 'Related CPT',
            'fields'   => array(
                wes_acf_text( 'field_rcpt_heading', 'Heading', 'heading' ),
                wes_acf_text( 'field_rcpt_subtitle', 'Subtitle', 'subtitle' ),
                array( 
                    'key'           => 'field_rcpt_bg', 
                    'label'         => 'Background', 
                    'name'          => 'bg', 
                ...
                array(
                    ...
                    'choices' => array(
                        ...
                        'cpt_input_order'  => 'Custom Post Type Input Order (As written)',
                    ),
                ...
                array(
                    ...
                    'name'          => 'include_posts',
                    'type'          => 'post_object',
                    'post_type'     => array( 'howto', 'checklist', 'explainer', 'resource', 'resource_card', 'post', 'page' ),
                    'field_type'    => 'select',
                    'multiple'      => 1,
                    'ui'            => 1,
                    'ajax'          => 1,
                ...
                array(
                    ...
                    'ajax'          => 1,
                    'return_format' => 'id',
                    'instructions'  => 'Select posts to exclude from the results.',
                ),
            ),
            'location' => array( 
                array( 
	...
	acf_add_local_field_group( array(
		...
		'fields'   => array(
			wes_acf_textarea( 'field_co_text', 'Statement', 'text', 2 ),
			array(
				'key'           => 'field_co_custom_quote',
	...
	acf_add_local_field_group( array(
		'key'      => 'group_block_media_text',
		'title'    => 'Media + Text',
		'fields'   => array(
			wes_acf_image( 'field_mt_image', 'Image', 'image' ),
			wes_acf_text( 'field_mt_alt', 'Image alt text (SEO)', 'alt' ),
			array( 'key' => 'field_mt_body', 'label' => 'Text', 'name' => 'body', 'type' => 'wysiwyg', 'media_upload' => 0, 'tabs' => 'visual' ),
			array( 'key' => 'field_mt_pos', 'label' => 'Image position', 'name' => 'position', 'type' => 'button_group', 'choices' => array( 'left' => 'Left', 'right' => 'Right' ), 'default_value' => 'left' ),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-media-text' ) ) ),
	) );

	acf_add_local_field_group( array(
		'key'      => 'group_block_checklist_rows',
		'title'    => 'Illustrated Checklist',
		'fields'   => array(
			array(
				'key' => 'field_clr_items', 'label' => 'Rows', 'name' => 'items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add row',
				'sub_fields' => array(
					wes_acf_image( 'field_clr_img', 'Illustration', 'image' ),
					array( 'key' => 'field_clr_color', 'label' => 'Number colour', 'name' => 'color', 'type' => 'select', 'choices' => array( 'teal' => 'Teal', 'green' => 'Green', 'blue' => 'Blue', 'gold' => 'Gold', 'orange' => 'Orange' ) ),
					wes_acf_text( 'field_clr_title', 'Title', 'title' ),
					wes_acf_textarea( 'field_clr_text', 'Description', 'text', 3 ),
				),
			),
		),
		'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-checklist-rows' ) ) ),
	) );

        acf_add_local_field_group( array(
			'key'      => 'group_block_principles',
			'title'    => 'Principles List',
			'fields'   => array(
				array(
					'key' => 'field_pr_items', 'label' => 'Principles', 'name' => 'items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add principle',
					'sub_fields' => array(
						...
						wes_acf_textarea( 'field_pr_practice', 'In practice', 'practice', 3 ),
						wes_acf_textarea( 'field_pr_practice_crossed', 'In Practice - Crossed Text (Strikethrough)', 'practice_crossed', 2 ),
                        wes_acf_textarea( 'field_pr_practice_normal', 'In Practice - Normal Text', 'practice_normal', 2 ),
                        wes_acf_textarea( 'field_pr_quick_check', 'Quick check', 'quick_check', 2 ),
						wes_acf_textarea( 'field_pr_why', 'Why this works', 'why', 3 ),
                        wes_acf_textarea( 'field_pr_why_part_2', 'Why this works - Part 2', 'why_part_2', 3 ),
					),
				),
			),
			'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-principles' ) ) ),
		) );

		acf_add_local_field_group( array(
			'key'      => 'group_block_resource_cards',
			'title'    => 'Resource Cards',
			'fields'   => array(
				array(
					'key' => 'field_rc_items', 'label' => 'Cards', 'name' => 'items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add card',
					'sub_fields' => array(
						wes_acf_text( 'field_rc_cat', 'Category label', 'cat' ),
						wes_acf_text( 'field_rc_title', 'Title', 'title' ),
						wes_acf_textarea( 'field_rc_text', 'Description', 'text', 3 ),
						wes_acf_text( 'field_rc_meta', 'Meta (e.g. reading time)', 'meta' ),
						wes_acf_text( 'field_rc_org', 'Publishing organization', 'org' ),
						wes_acf_textarea( 'field_rc_overview', 'Brief overview', 'overview', 3 ),
						wes_acf_text( 'field_rc_flags', 'Flags (pipe-separated, e.g. en|fr)', 'flags' ),
						wes_acf_text( 'field_rc_tags', 'Tags (pipe-separated)', 'tags' ),
						wes_acf_text( 'field_rc_link', 'Link', 'link' ),
					),
				),
					wes_acf_text( 'field_rc_cta', 'CTA label (optional, after grid)', 'cta' ),
					wes_acf_text( 'field_rc_ctalink', 'CTA link', 'cta_link' ),
			),
		...
		acf_add_local_field_group( array(
        	...
        	'fields'   => array(
        		...
        		array(
        			...
        			'default_value' => 9,
        			'min'           => -1,
        			'instructions'  => 'Number of cards per page. Enter -1 for unlimited per page.',
        		),
        		array(
        			'key'           => 'field_rc_dyn_max_posts',
        			'label'         => 'Max Posts (Total)',
        			'name'          => 'max_posts',
        			'type'          => 'number',
        			'default_value' => -1,
        			'min'           => -1,
        			'instructions'  => 'Maximum total cards across all pages. Enter -1 for unlimited.',
        		),
        		array(
        			'key'           => 'field_rc_dyn_action_types',
        			...
        			'allow_null'    => 0,
        			'return_format' => 'slug',
        			'instructions'  => 'Select one or more action types to filter the cards.',
        		),
        		array(
        			'key'           => 'field_rc_dyn_audiences',
        			...
        			'allow_null'    => 0,
        			'return_format' => 'slug',
        			'instructions'  => 'Select one or more audiences to filter the cards.',
        		),
        		array(
                    'key'           => 'field_rc_dyn_bg_color',
        		...
        		array(
        			'key'           => 'field_rc_dyn_cta',
        			'label'         => 'CTA Button Text',
        			'name'          => 'cta',
        			'type'          => 'text',
        			'instructions'  => 'Text for the call-to-action button at the bottom.',
        		),
        		array(
        			'key'           => 'field_rc_dyn_cta_link',
		...
		acf_add_local_field_group( array(
			...
			'fields'   => array(
				wes_acf_text( 'field_fr_eyebrow', 'Eyebrow', 'eyebrow' ),
				wes_acf_text( 'field_fr_title', 'Title', 'title' ),
				wes_acf_text( 'field_fr_org', 'Publishing organization', 'org' ),
				wes_acf_textarea( 'field_fr_overview', 'Brief overview', 'overview', 4 ),
				wes_acf_text( 'field_fr_flags', 'Flags (pipe-separated)', 'flags' ),
				wes_acf_text( 'field_fr_tags', 'Tags (pipe-separated)', 'tags' ),
				array( 'key' => 'field_fr_image', 'label' => 'Illustration', 'name' => 'image', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium' ),
				wes_acf_text( 'field_fr_link', 'Link', 'link' ),
			),
			'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-featured-resource' ) ) ),
		) );
		...
		acf_add_local_field_group( array(
            ...
            'fields'   => array(
                ...
                array(
                    ...
                    'name'          => 'eyebrow',
                    'type'          => 'text',
                    'instructions'  => 'Leave empty to use "Featured Resource" (translated).',
                    'default_value' => '',
                ),
                array(
                    ...
                    'type'          => 'color_picker',
                    'default_value' => '#ffffff',
                    'instructions'  => 'Select a background color for the featured section.',
                ),
            ),
            'location' => array(
                array(
		...
		acf_add_local_field_group( array(
			'key'      => 'group_block_begin_cards',
			'title'    => 'Begin Cards',
			'fields'   => array(
				array(
					'key' => 'field_bc_items', 'label' => 'Cards', 'name' => 'items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add card',
					'sub_fields' => array(
						array( 'key' => 'field_bc_image', 'label' => 'Illustration', 'name' => 'image', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium' ),
						wes_acf_text( 'field_bc_category', 'Category eyebrow', 'category' ),
						wes_acf_text( 'field_bc_title', 'Title', 'title' ),
						wes_acf_text( 'field_bc_org', 'Publishing organization', 'org' ),
						wes_acf_textarea( 'field_bc_overview', 'Brief overview', 'overview', 3 ),
						wes_acf_text( 'field_bc_flags', 'Flags (pipe-separated)', 'flags' ),
						wes_acf_text( 'field_bc_link', 'Link', 'link' ),
					),
				),
					wes_acf_text( 'field_bc_cta', 'CTA label (optional, after grid)', 'cta' ),
					wes_acf_text( 'field_bc_ctalink', 'CTA link', 'cta_link' ),
			),
		...
		acf_add_local_field_group( array(
            ...
            'fields'   => array(
                ...
                array(
                    ...
                    'name'          => 'cta',
                    'type'          => 'text',
                    'instructions'  => 'Optional call-to-action button below the cards.',
                ),
                array(
                    'key'           => 'field_bcn_cta_link',
                    'label'         => 'CTA Button Link',
                    'name'          => 'cta_link',
                    'type'          => 'url',
		...
		acf_add_local_field_group( array(
            ...
            'fields'   => array(
                array(
                    ...
                    'multiple'      => 0,
                    'allow_null'    => 0,
                    'instructions'  => 'Choose a resource card post to display.',
                ),
            ),
            'location' => array(
                array(
		...
		acf_add_local_field_group( array(
			...
			'fields'   => array(
				wes_acf_text( 'field_rlib_heading', 'Heading', 'heading' ),
				wes_acf_textarea( 'field_rlib_lead', 'Lead', 'lead', 2 ),
				array(
					'key' => 'field_rlib_tabs', 'label' => 'Tabs', 'name' => 'tabs', 'type' => 'repeater', 'layout' => 'table', 'button_label' => 'Add tab',
					'sub_fields' => array( wes_acf_text( 'field_rlib_tlabel', 'Tab label', 'label' ) ),
				),
				array(
					'key' => 'field_rlib_rows', 'label' => 'Rows', 'name' => 'rows', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add row',
					'sub_fields' => array(
						wes_acf_text( 'field_rlib_rtitle', 'Title', 'title' ),
						wes_acf_text( 'field_rlib_rorg', 'Publishing organization', 'org' ),
						wes_acf_text( 'field_rlib_rtags', 'Tags (pipe-separated)', 'tags' ),
						wes_acf_text( 'field_rlib_rlink', 'Link', 'link' ),
					),
				),
			),
		...
		acf_add_local_field_group( array(
			'key'      => 'group_block_audience_guide',
			...
			'location' => array( array( array( 'param' => 'block', 'operator' => '==', 'value' => 'acf/wes-audience-guide' ) ) ),
		) );
		...
		acf_add_local_field_group( array(
			...
			'fields'   => array(
				wes_acf_text( 'field_ti_heading', 'Heading', 'heading' ),
				wes_acf_textarea( 'field_ti_lead', 'Lead', 'lead', 2 ),
				array(
					'key' => 'field_ti_items', 'label' => 'Themes', 'name' => 'items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add theme',
					'sub_fields' => array(
						wes_acf_text( 'field_ti_name', 'Theme name', 'name' ),
						wes_acf_text( 'field_ti_tags', 'Tags (comma-separated)', 'tags' ),
					),
				),
			),
