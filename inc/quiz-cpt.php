...
function wes_register_quiz_fields() {
	...
	acf_add_local_field_group(
		array(
			...
			'fields' => array(
				array(
					'key'   => 'field_wes_quiz_intro_tab',
					'label' => 'Intro',
					'type'  => 'tab',
				),
				array(
					'key'   => 'field_wes_quiz_intro_eyebrow',
					'label' => 'Eyebrow',
					'name'  => 'quiz_intro_eyebrow',
					'type'  => 'text',
				),
				array(
					'key'       => 'field_wes_quiz_intro_title',
					'label'     => 'Title',
					'name'      => 'quiz_intro_title',
					'type'      => 'text',
					'required'  => 1,
				),
				array(
					'key'       => 'field_wes_quiz_intro_lead',
					'label'     => 'Lead',
					'name'      => 'quiz_intro_lead',
					'type'      => 'textarea',
					'rows'      => 4,
					'new_lines' => '',
				),
				array(
					'key'       => 'field_wes_quiz_intro_note',
					'label'     => 'Note',
					'name'      => 'quiz_intro_note',
					'type'      => 'textarea',
					'rows'      => 3,
					'new_lines' => '',
				),
				array(
					'key'   => 'field_wes_quiz_intro_start',
					'label' => 'Start button text',
					'name'  => 'quiz_intro_start',
					'type'  => 'text',
				),

				array(
					'key'   => 'field_wes_quiz_ui_tab',
					'label' => 'UI Labels',
					'type'  => 'tab',
				),
				array(
					'key'   => 'field_wes_quiz_ui_progress',
					'label' => 'Progress',
					'name'  => 'quiz_ui_progress',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_wes_quiz_ui_multi',
					'label' => 'Multiple-answer helper',
					'name'  => 'quiz_ui_multi',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_wes_quiz_ui_single',
					'label' => 'Single-answer helper',
					'name'  => 'quiz_ui_single',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_wes_quiz_ui_next',
					'label' => 'Next',
					'name'  => 'quiz_ui_next',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_wes_quiz_ui_back',
					'label' => 'Back',
					'name'  => 'quiz_ui_back',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_wes_quiz_ui_results',
					'label' => 'Results',
					'name'  => 'quiz_ui_results',
					'type'  => 'text',
				),
				array(
					'key'   => 'field_wes_quiz_ui_retake',
					'label' => 'Retake',
					'name'  => 'quiz_ui_retake',
					'type'  => 'text',
				),
				...
				array(
					'key'   => 'field_wes_quiz_questions_tab',
					'label' => 'Questions',
					'type'  => 'tab',
				),
				array(
					'key'          => 'field_wes_quiz_questions',
					'label'        => 'Questions',
					'name'         => 'quiz_questions',
					'type'         => 'repeater',
					'layout'       => 'block',
				...
				array(
					'key'   => 'field_wes_quiz_profiles_tab',
					'label' => 'Profiles',
					'type'  => 'tab',
				),
				array(
					'key'          => 'field_wes_quiz_profiles',
					'label'        => 'Profiles',
					'name'         => 'quiz_profiles',
					'type'         => 'repeater',
					'layout'       => 'block',
...
function wes_import_quiz_json() {
	...
	foreach ( $langs as $lang ) {
		...
		$post_id = ! empty( $existing ) ? (int) $existing[0] : wp_insert_post(
			...
			'post_type'   => 'quiz',
			'post_status' => 'publish',
			'post_title'  => 'Climate Quiz (' . strtoupper( $lang ) . ')',
