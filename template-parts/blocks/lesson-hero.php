...
$sub_eyebrow = get_field( 'sub_eyebrow' ); // New optional field
...
// Render sub eyebrow markup safely if it exists
if ( $sub_eyebrow ) {
...
?>
<section class="lesson-hero<?php echo $decor ? ' lesson-hero--decor' : ''; ?>">
	<?php if ( $decor ) : ?><img class="lesson-hero__wave" src="<?php echo esc_url( wes_img( 'brand-wave-gold.svg' ) ); ?>" alt="" aria-hidden="true"><?php endif; ?>
	<div class="container lesson-hero__inner">
		<div class="lesson-hero__text">
			<?php if ( $decor ) : ?>
				<div class="lesson-hero__head">
					<img class="lesson-hero__emblem" src="<?php echo esc_url( wes_img( 'logo.svg' ) ); ?>" alt="" width="106" height="135">
					<div class="lesson-hero__headings">
						<?php echo $eyebrow_html; // phpcs:ignore WordPress.Security.EscapeOutput ?>
						<h1 class="lesson-hero__title"><?php echo esc_html( $title ?: 'Lesson title' ); ?></h1>
	...
	<?php if ( ! $decor ) : ?><img class="lesson-hero__cream-wave" src="<?php echo esc_url( wes_img( 'cream-wave.svg' ) ); ?>" alt="" aria-hidden="true"><?php endif; ?>
</section>